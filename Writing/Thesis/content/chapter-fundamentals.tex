...
The core of machine learning is learning algorithms, which are used to induce a general model from a set of data samples. The concept of machine learning is explained here with the help of an example. % Further what happens exactly here 
