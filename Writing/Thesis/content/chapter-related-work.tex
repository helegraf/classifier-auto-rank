...
% Could do ranking by using meta-knowledge (avg ranking)
...
% Could do ranking by evaluating on the spot (active testing)

% Another interesting thing is that both of these could be improved by incorporating time
